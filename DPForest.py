...
from RandomForest import Statistics
...
class DPRandomForest(skRandomForestClassifier, DiffprivlibMixin):  # pylint: disable=too-many-ancestors
    ...
    def __init__(self, numberOfTrees, criterion_input, parameter, classes, *, epsilon=1.0, bounds=None, n_jobs=1, verbose=0, accountant=None,
        ...
        self.base_estimator = DecisionTreeClassifier(criterion=criterion_input)
        self.estimator_params = ("max_depth", "epsilon", "bounds", "classes")

        self._warn_unused_args(unused_args)

        # respecting the code definition
    ...
    def fit(self, X, y, sample_weight=None):
        ...
        print("Training finished with epsilon:", round(self.epsilon,2))
        end = time.time()
